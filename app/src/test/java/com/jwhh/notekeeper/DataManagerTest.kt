...
class DataManagerTest {
    ...
    // Create a setup first before each test runs
    @Before
    fun setUp() {
    ...
    fun addNote() {
        ...
        val noteText = "This is the body of test note"
    ...
    // To ensure that findNote() works correctly
    @Test
    fun findSimilarNotes() {
        val course = DataManager.courses["android_async"]!!
        val noteTitle = "This is a test note"
        val noteText1 = "This is the body of test note"
        val noteText2 = "This is the body of second test note"
